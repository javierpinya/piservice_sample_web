...
from . import views
from .views import VehiculoListView,VehiculoDetailView,VehiculoCreateView,CompartimentoCreateView,VehiculoUpdateView,VehiculoDeleteView,VehiculoSearchView,VehiculoDashboard

vehiculos_patterns = ([
    path('', VehiculoDashboard.as_view(), name="vehiculos_dashboard"),
    path('listado', VehiculoListView.as_view(), name="vehiculos"),
